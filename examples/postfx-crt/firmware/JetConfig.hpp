...
// A layered arcade backdrop and convex cube use painter rendering.
// Nearest affine sampling keeps the CRT comparison inexpensive.
...
#define POSTFX_CRT 1         // CRT scanline effect
...
#define CRT_SCANLINE_INTENSITY 112    // Intensity of CRT scanlines (0-255)
